...
const FooterDesktop = ({ onAddCashClick, onAddCryptoClick }) => {
  ...
  return (
    ...
    >
      <div className="flex flex-row justify-between w-full px-8 mt-8">
        <div
          className="absolute top-8 left-[215px] transform -translate-x-1/2 w-[64px] h-[64px] bg-gradient-to-b from-[#525AFF] to-[#0A23C3] rounded-full flex items-center justify-center shadow-lg"
          onClick={handleClick}
        >
        ...
        <div className="flex w-full justify-center items-center mt-16">
          <div className="flex gap-3 justify-center items-center">
            ...
            <button
              ...
              onClick={onAddCashClick} // Передаем функцию из родительского компонента
            >
              <BsPlus size={24} />
              Add Cash
            </button>
            ...
            <button
              ...
              onClick={onAddCryptoClick} // Передаем функцию из родительского компонента
            >
              <BsPlus size={24} />
              Add Crypto
            </button>
